...
module "eks_blueprints_kubernetes_addons" {
  ...
  # EKS Addons
  enable_amazon_eks_aws_ebs_csi_driver = lookup(var.cluster_addons, "enable_amazon_eks_aws_ebs_csi_driver", false)
  amazon_eks_aws_ebs_csi_driver_config = var.amazon_eks_aws_ebs_csi_driver_config
  enable_amazon_eks_coredns            = lookup(var.cluster_addons, "enable_amazon_eks_coredns", false)
  amazon_eks_coredns_config            = var.amazon_eks_coredns_config
  enable_amazon_eks_kube_proxy         = lookup(var.cluster_addons, "enable_amazon_eks_kube_proxy", false)
  amazon_eks_kube_proxy_config         = var.amazon_eks_kube_proxy_config
  enable_amazon_eks_vpc_cni            = lookup(var.cluster_addons, "enable_amazon_eks_vpc_cni", false)
  ...
  argocd_manage_add_ons = var.enable_argocd
